    ...
    <header>
        <div class="breadcrumb">
            ...
            <div class="container text-center">
                ...
                <p class="mb-0 unit-6"><a href="index.html">Home</a> <span class="sep">></span> <span>Add New Article</span></p>
            </div>
        </div>
        <!--    breadcrumb-->
    </header>
                ...
                <form action="">
                    <table class="table table-bordered mx-auto">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th class="mx-" colspan="2"><button class="btn btn-success " type="submit" name="publish" value="publish">Publish</button></th>
                            </tr>
                        </tbody>
                    </table>
                </form>
